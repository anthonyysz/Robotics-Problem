...
&nbsp;&nbsp;&nbsp;&nbsp;I had never written anything using Lua before, so I was a bit nervous going into the script writing part of this assignment. Once I saw the sample code provided and understood what was asked of me, Lua came naturally. The documentation was very easy to navigate, and I was writing like I'd known the language for years. CoppeliaSim took a bit more getting used to, but that had more to do with the camera controls than anything else. I really had a fun time working on all of this, and I felt inspired by robotics and this course to really push myself.
